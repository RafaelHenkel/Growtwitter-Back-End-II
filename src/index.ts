...
const user1 = new User("RafaelHenkelUser1", "rafael@gmail.com", "1234567a");
const user2 = new User("RafaelUser2", "rafael234@gmail.com", "1234567a123");
const user3 = new User("User3", "rafaellll234@gmail.com", "1234567a123ll");
